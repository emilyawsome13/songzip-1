    ...
    web_settings.update(
        {
            ...
            "keep_alive": True,
            "keep_sessions": True,
            "bundle_flatten": _env_bool("SPOTDL_BUNDLE_FLATTEN", False),
            "web_use_output_dir": _env_bool("SPOTDL_WEB_USE_OUTPUT_DIR", False),
            "bundle_compression": os.environ.get("SPOTDL_BUNDLE_COMPRESSION", "deflate"),
            "allowed_origins": _env_list("SPOTDL_ALLOWED_ORIGINS"),
            "forced_format": os.environ.get("SPOTDL_FORCED_FORMAT"),
            "forced_output": os.environ.get("SPOTDL_FORCED_OUTPUT"),
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="SongZip",
        description="Hosted SongZip web app",
        version=__version__,
